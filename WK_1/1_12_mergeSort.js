...
-> takes in two soreted arrays
-> merges them into one sorted array
-> okay to create a new array

? Merge Sort Functions
-> divide and conquer algorithm
-> takes in an unsorted array
-> splits it in half (as closely as possible)
-> recursively calls itself util each half consists of only oone element
-> an array with one element is sorted by definition
-> calls the merge helper function to merge the two sorted halbes

? Recursive Function
-> base case (how does recursion end?)
-> progress towards that base case
-> must call itself to be recursive
*/
